...
public class Crypteur extends Securite{
	...
	/**
	 * Le constructeur de la classe Crypteur récupère une chaine de caractères et utilise la méthode cryptage
	 * pour crypter cette chaine.
	 * 
	 * @param msgVierge
	 */
	...
	/**
	 * La méthode cryptage utilise les autres méthodes tabNbPremier, tabAscii, tabCrypte et charToString pour
	 * crypter la chaine de caractères récupérée.
	 * 
	 * @param message
	...
	/**
	 * La méthode tabAscii transforme une chaîne de caractères en un tableau d'entiers (équivalent Ascii de chaque caractère)
	 * 
	 * @param message
	 * @return tabAscii
	 */
	...
	/**
	 * La méthode tabCrypte transforme un tableau d'entier (équivalent Ascii de chaque caractère) en un tableau de caractères
